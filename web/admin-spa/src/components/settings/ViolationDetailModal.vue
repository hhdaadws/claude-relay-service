    ...
    <div class="w-full max-w-2xl rounded-lg bg-white p-6 shadow-xl dark:bg-gray-800">
      ...
      <div class="space-y-4">
        ...
        <div class="rounded-lg bg-gray-50 p-4 dark:bg-gray-700/50">
          ...
          <div class="mt-1 text-xs text-gray-500 dark:text-gray-400">ID: {{ log.apiKeyId }}</div>
        </div>
        ...
        <div class="rounded-lg bg-red-50 p-4 dark:bg-red-900/20">
          <div
            class="mb-2 text-xs font-medium uppercase tracking-wide text-red-700 dark:text-red-400"
          >
            命中的敏感词
          </div>
          <div class="flex flex-wrap gap-2">
            <div
              v-for="(match, index) in log.matchedWords"
              :key="index"
              class="rounded-lg bg-red-100 px-3 py-2 dark:bg-red-900/40"
            >
        ...
        <div class="rounded-lg bg-gray-50 p-4 dark:bg-gray-700/50">
          ...
          <div
            class="whitespace-pre-wrap rounded bg-white p-3 text-sm text-gray-800 dark:bg-gray-800 dark:text-gray-200"
          >
            {{ log.contentSample }}
          </div>
          <div class="mt-2 text-xs text-gray-500 dark:text-gray-400">仅显示前 200 个字符</div>
        </div>
